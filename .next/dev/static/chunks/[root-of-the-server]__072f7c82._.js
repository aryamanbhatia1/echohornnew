...
function ConsumerPortal() {
    ...
    const [complaintForm, setComplaintForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        title: '',
        detail: '',
        bookingId: ''
    });
    ...
    const [backendComplaints, setBackendComplaints] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const myBookings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConsumerPortal.useMemo[myBookings]": ()=>{
            ...
            }["ConsumerPortal.useMemo[myBookings]"]).map({
                "ConsumerPortal.useMemo[myBookings]": (booking)=>{
                    const driver = store.drivers.find({
                        "ConsumerPortal.useMemo[myBookings].driver": (item)=>item.id === booking.driverId
                    }["ConsumerPortal.useMemo[myBookings].driver"]);
                    const driverUser = store.users.find({
                        "ConsumerPortal.useMemo[myBookings].driverUser": (item)=>item.id === driver?.userId
                    }["ConsumerPortal.useMemo[myBookings].driverUser"]);
                    const owner = store.users.find({
                        "ConsumerPortal.useMemo[myBookings].owner": (item)=>item.id === booking.ownerId
                    }["ConsumerPortal.useMemo[myBookings].owner"]);
                    const truck = store.trucks.find({
                        "ConsumerPortal.useMemo[myBookings].truck": (item)=>item.id === booking.truckId
                    }["ConsumerPortal.useMemo[myBookings].truck"]);
                    return {
                        booking,
                        driverUser,
                        owner,
    ...
    const openComplaints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConsumerPortal.useMemo[openComplaints]": ()=>{
            if (backendToken) return [];
            if (!session) return [];
            return store.complaints.filter({
                "ConsumerPortal.useMemo[openComplaints]": (complaint)=>complaint.customerId === session.id
            }["ConsumerPortal.useMemo[openComplaints]"]);
        }
    }["ConsumerPortal.useMemo[openComplaints]"], [
        backendToken,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConsumerPortal.useEffect": ()=>{
            if (!backendToken) return;
            void ({
                "ConsumerPortal.useEffect": async ()=>{
                    try {
                        const [bookings, complaints] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listConsumerBookings"])(backendToken),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listComplaints"])(backendToken)
                        ]);
        ...
        void (async ()=>{
            try {
                if (mode === 'signup') {
                    ...
                    const sessionData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerConsumerBackend"])({
                        first_name,
                        last_name,
        ...
        void (async ()=>{
            if (backendToken) {
                try {
                    ...
                    const serviceRequest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createServiceRequest"])(backendToken, {
                    ...
                    const available = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAvailableDrivers"])(backendToken, createdRequest.id);
                    const backendDriver = available.available_drivers?.[0];
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBackendBooking"])(backendToken, {
                    ...
                    setBackendBookings(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listConsumerBookings"])(backendToken));
    ...
    const handleComplaint = ()=>{
        ...
        void (async ()=>{
            if (backendToken) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBackendComplaint"])(backendToken, {
                    ...
                    setBackendComplaints(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$logistics$2d$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listComplaints"])(backendToken));
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$lib$2f$demo$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createComplaint"])({
                customerId: session.id,
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$space_grotesk_f63d7297$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} text-xl font-semibold`,
                                                    children: "Available trucks and drivers"
                                                }, void 0, false, {
                                                    fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                    lineNumber: 408,
                                                    columnNumber: 17
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} mt-2 text-sm text-slate-300`,
                                                    children: "Select an available fleet option, then send the request for owner approval."
                                                }, void 0, false, {
                                                    fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                    lineNumber: 409,
                                                    columnNumber: 17
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Choose a nearby truck option above, then submit the booking request. The fleet owner must accept it before the trip becomes active."
                                        }, void 0, false, {
                                            fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                            lineNumber: 475,
                                            columnNumber: 15
                                        ...
                                        selectedDriverId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: "Fleet option selected and ready to send for approval."
                                        }, void 0, false, {
                                            fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                            lineNumber: 479,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                !backendToken && myBookings.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                backendToken && backendBookings.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300`,
                                                    children: "No backend bookings yet. Submit a request to create one."
                                                }, void 0, false, {
                                                    fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                    lineNumber: 504,
                                                    columnNumber: 19
                                                }, this),
                                                backendToken && backendBookings.map((booking)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} mt-3 flex flex-wrap gap-2 text-sm`,
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: `rounded-full px-3 py-1 ${booking.advance_paid ? 'bg-emerald-400/10 text-emerald-100' : 'bg-amber-400/10 text-amber-100'}`,
                                                                        children: booking.advance_paid ? 'Advance paid' : 'Awaiting payment'
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                                        lineNumber: 518,
                                                                        columnNumber: 23
                                                ...
                                                myBookings.map(({ booking, driverUser, owner, truck })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "rounded-2xl border border-white/10 bg-white/5 p-4",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$space_grotesk_f63d7297$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} text-lg font-semibold text-white`,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} mt-2 text-sm text-slate-400`,
                                                                children: [
                                                                    "Fleet owner: ",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        ...
                                                                        children: booking.status === 'pending_approval' ? 'Waiting for owner approval' : booking.status.replace('_', ' ')
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                                        lineNumber: 543,
                                                                        columnNumber: 23
                                                                    }, this),
                                                                    booking.rejectionReason && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "rounded-full bg-rose-400/10 px-3 py-1 text-rose-100",
                                                                        children: booking.rejectionReason
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                                        lineNumber: 557,
                                                                        columnNumber: 25
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} mt-3 text-sm text-slate-300`,
                                            children: "Raise a complaint here if a booking, payout, confirmation, or trip update needs employee attention."
                                        }, void 0, false, {
                                            fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                            lineNumber: 570,
                                            columnNumber: 15
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: "",
                                                            children: "Link to booking (optional)"
                                                        }, void 0, false, {
                                                            fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                            lineNumber: 580,
                                                            columnNumber: 21
                                                        ...
                                                        (backendToken ? backendBookings : myBookings).map((entry)=>{
                                                            ...
                                                            const label = backendToken ? `${booking.service_request_details?.pickup_address} to ${booking.service_request_details?.drop_address}` : `${booking.from} to ${booking.to}`;
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                value: booking.id,
                                                                children: label
                                                            }, booking.id, false, {
                                                                fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                !backendToken && openComplaints.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300`,
                                                    children: "No complaints raised yet."
                                                }, void 0, false, {
                                                    fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                    lineNumber: 613,
                                                    columnNumber: 19
                                                }, this),
                                                backendToken && backendComplaints.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300`,
                                                    children: "No backend complaints raised yet."
                                                }, void 0, false, {
                                                    fileName: "[project]/EchoHorn/components/consumer/ConsumerPortal.tsx",
                                                    lineNumber: 618,
                                                    columnNumber: 19
                                                }, this),
                                                backendToken && backendComplaints.map((complaint)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "rounded-2xl border border-white/10 bg-white/5 p-4",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$space_grotesk_f63d7297$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} text-lg font-semibold text-white`,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$inter_de953415$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} mt-3 text-xs uppercase tracking-[0.2em] text-cyan-200/80`,
                                                ...
                                                openComplaints.map((complaint)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "rounded-2xl border border-white/10 bg-white/5 p-4",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$EchoHorn$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: `${__TURBOPACK__imported__module__$5b$next$5d2f$internal$2f$font$2f$google$2f$space_grotesk_f63d7297$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].className} text-lg font-semibold text-white`,
...
_s(ConsumerPortal, "jlKoG+ie/nOfSve59QfPM91RnV0=");
_c = ConsumerPortal;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__072f7c82._.js.map